<?php
session_start();
$_SESSION['page'] = "stuffingcon";
include "koneksi.php";

$sql = mysqli_query($koneksi, "SELECT * FROM stuffingCon");
...
<head>
    <meta charset="utf-8" />
    <title>Data Stuffing Container</title>
                                ...
                                <table id="container" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        for ($i = 0; $i < $counter; $i++) { 
                                            ...
                                            echo '<a href="formstuffingcon.php?no=' . $no[$i] . '" class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"> <i class="fa fa-pencil"></i></a>';
