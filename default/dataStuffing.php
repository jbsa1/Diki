                                ...
                                <table id="container" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        for ($i = 0; $i < $counter; $i++) { 
                                            ...
                                            echo '<a href="formstuffing.php?no=' . $no[$i] . '" class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"> <i class="fa fa-pencil"></i></a>';
